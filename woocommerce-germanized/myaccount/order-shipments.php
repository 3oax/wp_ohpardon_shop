...
<?php if ( ! empty( $shipments ) ) : ?>
	<h2 class="woocommerce-shipments-list__title mb-1"><?php _ex( 'Shipments', 'shipments', 'woocommerce-germanized' ); ?></h2>
...
<?php if ( ! empty( $returns ) ) : ?>
	<h2 class="woocommerce-shipments-list__title woocommerce-return-shipments-list__title mb-1"><?php _ex( 'Returns', 'shipments', 'woocommerce-germanized' ); ?></h2>
