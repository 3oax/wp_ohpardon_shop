...
<div class="flex flex-wrap w-full xoo-el-action-action-row">
	<div class="w-1/2 pr-025">
		<input type="hidden" name="_xoo_el_form" value="login">
		<button type="submit" class="btn btn--sm xoo-el-action-btn xoo-el-login-btn" <?php if( !xoo_el_is_limit_login_ok() ) echo "disabled"; ?>><?php _e('Sign In','easy-login-woocommerce'); ?></button>
		<input type="hidden" name="xoo_el_redirect" value="<?php echo esc_url( $redirect ); ?>">
	</div>
	<div class="w-1/2 pl-025 flex items-end" style="font-size: 0.4rem;">
		<a class="xoo-el-lostpw-tgr text-white"><?php _e('Forgot Password?','easy-login-woocommerce'); ?></a>
	</div>
</div>