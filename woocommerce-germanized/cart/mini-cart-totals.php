...
<?php if ( ! empty( $differential_taxation_info ) ) : ?>
    <p class="total differential-taxation-notice wc-gzd-total-mini-cart">
        <?php echo $differential_taxation_info; ?>
    </p>
<?php endif; ?>

<?php foreach ( $taxes as $tax ) : ?>
    <p class="total total-cart-tax wc-gzd-total-mini-cart flex flex-wrap justify-between text-xs">
        <span><?php echo wc_gzd_get_tax_rate_label( $tax['tax']->rate ); ?>:</span>
        <span><?php echo wc_price( $tax['amount'] ); ?></span>
    </p>
<?php endforeach; ?>
