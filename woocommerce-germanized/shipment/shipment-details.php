...
?>
<section class="woocommerce-shipment-details mb-1">
	<?php
	/**
	...
	<h2 class="woocommerce-shipment-details__title mb-1"><?php echo esc_html_x(  'Shipment details', 'shipments', 'woocommerce-germanized' ); ?></h2>
