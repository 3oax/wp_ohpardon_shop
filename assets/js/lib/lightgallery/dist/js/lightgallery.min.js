...
! ( function( e ){
	...
	return ( function e( t, s, l ){
		function i( r, d ){
			if ( ! s[r] ){
				if ( ! t[r] ){
					var a = 'function' === typeof require && require; if ( ! d && a ) {
						return a( r, ! 0 );
					} if ( o ) {
						return o( r, ! 0 ); 
					} var n = new Error( `Cannot find module '${r}'` ); throw n.code = 'MODULE_NOT_FOUND', n; 
				} var u = s[r] = { exports: {} }; t[r][0].call( u.exports, ( e ) => {
					var s = t[r][1][e];
						...
						if ( s ){
							var i = s.getAttribute( 'lg-event-uid' ); if ( i ){
								i = i.split( '&' ); for ( var o = 0; o < i.length; o++ ) {
									if ( i[o] ){
										var r = l + i[o]; if ( '.' === r.substring( 0, 1 ) ) {
											...
											s.removeEventListener( r.split( '.' )[0], t.Listener[r] ), s.setAttribute( 'lg-event-uid', s.getAttribute( 'lg-event-uid' ).replace( `&${i[o]}`, '' ) ), delete t.Listener[r]; 
										}
									} 
								} 
							} 
		...
		2: [function( t, s, l ){
			! ( function( s, i ){
				...
				function t( e ){
					...
					if ( this.el = e, this.s = i( {}, o, t ), this.s.dynamic && 'undefined' !== this.s.dynamicEl && this.s.dynamicEl.constructor === Array && ! this.s.dynamicEl.length ) {
				...
				}() ), window.utils = l.default, window.lgData = { uid: 0 }, window.lgModules = {}; var o = {
					mode: 'lg-slide',
					cssEasing: 'ease',
					easing: 'linear',
					speed: 600,
					...
					var e = this; e.s.preload > e.items.length && ( e.s.preload = e.items.length ); var t = window.location.hash; if ( t.indexOf( `lg=${this.s.galleryId}` ) > 0 && ( e.index = parseInt( t.split( '&slide=' )[1], 10 ), l.default.addClass( document.body, 'lg-from-hash' ), l.default.hasClass( document.body, 'lg-on' ) || ( l.default.addClass( document.body, 'lg-on' ), setTimeout( () => {
						e.build( e.index ); 
					} ) ) ), e.s.dynamic ) {
						l.default.trigger( this.el, 'onBeforeOpen' ), e.index = e.s.index || 0, l.default.hasClass( document.body, 'lg-on' ) || ( l.default.addClass( document.body, 'lg-on' ), setTimeout( () => {
							e.build( e.index ); 
						} ) ); 
					} else {
						for ( var s = 0; s < e.items.length; s++ ) {
							! ( function( t ){
								l.default.on( e.items[t], 'click.lgcustom', ( s ) => {
					...
					} t.slide( e, ! 1, ! 1 ), t.s.keyPress && t.keyPress(), t.items.length > 1 && ( t.arrow(), setTimeout( () => {
						t.enableDrag(), t.enableSwipe(); 
					}, 50 ), t.s.mousewheel && t.mousewheel() ), t.counter(), t.closeGallery(), l.default.trigger( t.el, 'onAfterOpen' ), l.default.on( t.outer, 'mousemove.lg click.lg touchstart.lg', () => {
						l.default.removeClass( t.outer, 'lg-hide-items' ), clearTimeout( t.hideBartimeout ), t.hideBartimeout = setTimeout( () => {
					...
					} var s; if ( s = this.s.dynamic ? this.s.dynamicEl[t].html : this.items[t].getAttribute( 'data-html' ), ! e && s ) {
						return { html5: ! 0 };
					...
					var i = this,
						...
						if ( m ) {
							...
							p ? ( i.___slide[e].insertAdjacentHTML( 'beforeend', '<div class="lg-video-cont "><div class="lg-video"></div></div>' ), l.default.trigger( i.el, 'hasVideo', {
								index: e,
								src: d,
								html: c 
					...
					}l.default.on( i.___slide[e].querySelector( '.lg-object' ), 'load.lg error.lg', () => {
						var t = 0; s && ! l.default.hasClass( document.body, 'lg-from-hash' ) && ( t = s ), setTimeout( () => {
							l.default.addClass( i.___slide[e], 'lg-complete' ), l.default.trigger( i.el, 'onSlideItemLoad', {
								index: e,
								delay: s || 0 
							} );
						}, t );
					} ), p && p.html5 && ! o && l.default.addClass( i.___slide[e], 'lg-complete' ), t === ! 0 && ( l.default.hasClass( i.___slide[e], 'lg-complete' ) ? i.preload( e ) : l.default.on( i.___slide[e].querySelector( '.lg-object' ), 'load.lg error.lg', () => {
						i.preload( e ); 
					} ) ); 
					...
					for ( var i = 0, o = 0; o < this.___slide.length; o++ ) {
						...
						var d = this.___slide.length, 
							...
							if ( this.s.download ){
								...
								fromTouch: t,
								fromThumb: s 
							} ), r.lgBusy = ! 0, clearTimeout( r.hideBartimeout ), '.lg-sub-html' === this.s.appendSubHtmlTo && setTimeout( () => {
									r.addHtml( e );
								...
								} e < i ? ( u = ! 0, 0 !== e || i !== d - 1 || s || ( u = ! 1, n = ! 0 ) ) : e > i && ( n = ! 0, e !== d - 1 || 0 !== i || s || ( u = ! 0, n = ! 1 ) ), u ? ( l.default.addClass( this.___slide[e], 'lg-prev-slide' ), l.default.addClass( this.___slide[i], 'lg-next-slide' ) ) : n && ( l.default.addClass( this.___slide[e], 'lg-next-slide' ), l.default.addClass( this.___slide[i], 'lg-prev-slide' ) ), setTimeout( () => {
							...
							}r.lGalleryOn ? ( setTimeout( () => {
								r.loadContent( e, ! 0, 0 ); 
							}, this.s.speed + 50 ), setTimeout( () => {
					...
					var t = this; t.lgBusy || ( t.index + 1 < t.___slide.length ? ( t.index++, l.default.trigger( t.el, 'onBeforeNextSlide', { index: t.index } ), t.slide( t.index, e, ! 1 ) ) : t.s.loop ? ( t.index = 0, l.default.trigger( t.el, 'onBeforeNextSlide', { index: t.index } ), t.slide( t.index, e, ! 1 ) ) : t.s.slideEndAnimatoin && ( l.default.addClass( t.outer, 'lg-right-end' ), setTimeout( () => {
						l.default.removeClass( t.outer, 'lg-right-end' ); 
					}, 400 ) ) );
				}, s.prototype.goToPrevSlide = function( e ){
					var t = this; t.lgBusy || ( t.index > 0 ? ( t.index--, l.default.trigger( t.el, 'onBeforePrevSlide', {
						index: t.index,
						fromTouch: e 
					} ), t.slide( t.index, e, ! 1 ) ) : t.s.loop ? ( t.index = t.items.length - 1, l.default.trigger( t.el, 'onBeforePrevSlide', {
						index: t.index,
						fromTouch: e 
					} ), t.slide( t.index, e, ! 1 ) ) : t.s.slideEndAnimatoin && ( l.default.addClass( t.outer, 'lg-left-end' ), setTimeout( () => {
						l.default.removeClass( t.outer, 'lg-left-end' ); 
					}, 400 ) ) ); 
				}, s.prototype.keyPress = function(){
					var e = this; this.items.length > 1 && l.default.on( window, 'keyup.lg', ( t ) => {
						e.items.length > 1 && ( 37 === t.keyCode && ( t.preventDefault(), e.goToPrevSlide() ), 39 === t.keyCode && ( t.preventDefault(), e.goToNextSlide() ) ); 
					} ), l.default.on( window, 'keydown.lg', ( t ) => {
					...
					var e = this; l.default.on( this.outer.querySelector( '.lg-prev' ), 'click.lg', () => {
						e.goToPrevSlide(); 
					} ), l.default.on( this.outer.querySelector( '.lg-next' ), 'click.lg', () => {
						e.goToNextSlide(); 
					} ); 
					...
					var e = this, 
						...
						for ( var o = 0; o < e.___slide.length; o++ ) {
							l.default.on( e.___slide[o], 'touchstart.lg', ( s ) => {
							...
							l.default.on( e.___slide[r], 'touchmove.lg', ( o ) => {
							...
							l.default.on( e.___slide[d], 'touchend.lg', () => {
					...
					var e = this, 
						...
						for ( var r = 0; r < e.___slide.length; r++ ) {
							l.default.on( e.___slide[r], 'mousedown.lg', ( s ) => {
						...
						} l.default.on( window, 'mousemove.lg', ( r ) => {
							i && ( o = ! 0, s = r.pageX, e.touchMove( t, s ), l.default.trigger( e.el, 'onDragmove' ) ); 
						} ), l.default.on( window, 'mouseup.lg', ( r ) => {
					...
					var e = this; l.default.on( e.outer, 'mousewheel.lg', ( t ) => {
						t.deltaY && ( t.deltaY > 0 ? e.goToPrevSlide() : e.goToNextSlide(), t.preventDefault() ); 
					} ); 
				}, s.prototype.closeGallery = function(){
					var e = this,
						t = ! 1; l.default.on( this.outer.querySelector( '.lg-close' ), 'click.lg', () => {
						e.destroy(); 
					} ), e.s.closable && ( l.default.on( e.outer, 'mousedown.lg', ( e ) => {
						t = Boolean( l.default.hasClass( e.target, 'lg-outer' ) || l.default.hasClass( e.target, 'lg-item' ) || l.default.hasClass( e.target, 'lg-img-wrap' ) );
					} ), l.default.on( e.outer, 'mouseup.lg', ( s ) => {
					...
					} this.lGalleryOn = ! 1, clearTimeout( t.hideBartimeout ), this.hideBartimeout = ! 1, l.default.off( window, '.lg' ), l.default.removeClass( document.body, 'lg-on' ), l.default.removeClass( document.body, 'lg-from-hash' ), t.outer && l.default.removeClass( t.outer, 'lg-visible' ), l.default.removeClass( document.querySelector( '.lg-backdrop' ), 'in' ), setTimeout( () => {
						try {
